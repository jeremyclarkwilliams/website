<section class="section section-skills section--black" id="section-skills">
    <div class="container">
        ...
        <table class="table-skills" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    <th><span class="sr-only">Skill</span></th>
                    <th>
                        <span class="sr-only">Skill Level:</span>
                        <span class="level-1">BASIC<span class="sr-only"> (1)</span></span>
                        <span class="sr-only">to</span>
                        <span class="level-10">ADVANCED<span class="sr-only"> (10)</span></span>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td class="skill-name">Accessibility &amp; SEO</td>
                    <td class="skill-level"><span class="bar">8</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="skill-name">Node &amp; Express</td>
                    <td class="skill-level"><span class="bar">1</span></td>
                </tr>
                <tr>
